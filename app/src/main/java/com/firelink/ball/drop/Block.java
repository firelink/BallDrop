...
public class Block 
{
	...
	/**
	 * Used to determine if the Block has clipping or not. 
	 * Clipping determines whether or not the Block interacts in collisions.
	 * Without clipping, an object will simply go through this object
	 */
